...
public class RequestMaker {
    ...
    public String getRequestTextByVisit(Visit visit){//создать класс
        String request = "";
        int counter = 0;
        if (visit.patient.trim().length() > 0){
            if(counter>0) {
                request += " AND patient = '" + visit.patient+"'";//добавить пустой слот
            }else{
        ...
        if (visit.service.trim().length() > 0){
            if(counter>0) {
                request += " AND service = '" + visit.service+"'";//добавить пустой слот
            }else{
        ...
        if (visit.date.trim().length() > 0){
            if(counter>0) {
                request += "AND date = '" + visit.date + "'";//добавить пустой слот
            }else{
    ...
    public String getRequestTextByService(Service service){
        ...
        if (service.patient.trim().length() > 0){
            if(counter>0) {
                request += " AND patient = '" + service.patient + "'";//добавить пустой слот
            }else{
        ...
        if (service.doctor.trim().length() > 0){
            if(counter>0) {
                request += " AND doctor = '" + service.doctor + "'";//добавить пустой слот
            }else{
        ...
        if (service.manipulation.trim().length() > 0){
            if(counter>0) {
                request += " AND manipulation = '" + service.manipulation + "'";//добавить пустой слот
            }else{
        ...
        if (service.cost > 0){
            if(counter>0) {
                request += " AND cost = " + service.cost;//добавить пустой слот
            }else{
        ...
        if (service.date.trim().length() > 0) {
            if(counter>0) {
                request += " AND date = '" + service.date + "'";//добавить пустой слот
            }else{
    ...
    public String getRequestTextByDoctor(Doctor doctor){
        ...
        if (doctor.name.trim().length() > 0){
            if(counter>0) {
                request += " AND doctor = '" + doctor.name + "'";//добавить пустой слот
            }else{
        ...
        if (doctor.passport.trim().length() > 0){
            if(counter>0) {
                request += " AND passport = '" + doctor.passport + "'";//добавить пустой слот
            }else{
        ...
        if (doctor.address.trim().length() > 0){
            if(counter>0) {
                request += " AND address = '" + doctor.address + "'";//добавить пустой слот
            }else{
        ...
        if (doctor.specialization.trim().length() > 0){
            if(counter>0) {
                request += " AND specialization = '" + doctor.specialization + "'";//добавить пустой слот
            }else{
        ...
        if (doctor.experience > 0){
            if(counter>0) {
                request += " AND experience = " + doctor.experience;//добавить пустой слот
            }else{
        ...
        if (doctor.berth.trim().length() > 0){
            if(counter>0) {
                request += " AND berth = '" + doctor.berth + "'";//добавить пустой слот
            }else{
    ...
    public String getRequestTextByPatient(Patient patient){
        ...
        if (patient.name.trim().length() > 0){
            if(counter>0) {
                request += " AND name = '" + patient.name + "'";//добавить пустой слот
            }else{
        ...
        if (patient.passport.trim().length() > 0){
            if(counter>0) {
                request += " AND passport = '" + patient.passport + "'";//добавить пустой слот
            }else{
        ...
        if (patient.address.trim().length() > 0){
            if(counter>0) {
                request += " AND address = '" + patient.address + "'";//добавить пустой слот
            }else{
        ...
        if (patient.disease.trim().length() > 0){
            if(counter>0) {
                request += " AND disease = '" + patient.disease + "'";//добавить пустой слот
            }else{
    ...
    public String getRequestTextByRender(Render render){
        ...
        if(render.service.trim().length() > 0){
            if(counter>0) {
                request += " AND service = '" + render.service + "'";//добавить пустой слот
            }else{
